...
# Transaction C: lyra-to-self, spend A
TXID_C=$( $CLI $B1ARGS lyratoaddress $B1ADDRESS 50.0)

# Transaction D: spends B and C
TXID_D=$( $CLI $B1ARGS lyratoaddress $B2ADDRESS 100.0)
...
MUTATEDTXID=$( $CLI $B2ARGS lyrarawtransaction $MUTATEDTX_C )

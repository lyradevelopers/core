...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-maxlyrabuffer=<n>", strprintf(_("Maximum per-connection lyra buffer, <n>*1000 bytes (default: %u)"), 1000));
    ...
    strUsage += HelpMessageOpt("-paytxfee=<amt>", strprintf(_("Fee (in LYRA/kB) to add to transactions you lyra (default: %s)"), FormatMoney(payTxFee.GetFeePerK())));
    strUsage += HelpMessageOpt("-rescan", _("Rescan the block chain for missing wallet transactions") + " " + _("on startup"));
    strUsage += HelpMessageOpt("-salvagewallet", _("Attempt to recover private keys from a corrupt wallet.dat") + " " + _("on startup"));
    strUsage += HelpMessageOpt("-lyrafreetransactions", strprintf(_("Lyra transactions as zero-fee transactions if possible (default: %u)"), 0));
    strUsage += HelpMessageOpt("-spendzeroconfchange", strprintf(_("Spend unconfirmed change when lyraing transactions (default: %u)"), 1));
    ...
    strUsage += HelpMessageOpt("-printtoconsole", strprintf(_("Lyra trace/debug info to console instead of debug.log file (default: %u)"), 0));
    if (GetBoolArg("-help-debug", false)) {
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2017-%i The LYRA Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (mapArgs.count("-paytxfee")) {
        ...
        if (nFeePerK > nHighTransactionFeeWarning)
            InitWarning(_("Warning: -paytxfee is set very high! This is the transaction fee you will pay if you lyra a transaction."));
    ...
    fLyraFreeTransactions = GetArg("-lyrafreetransactions", false);
...
// ********************************************************* Step 8: load wallet
    ...
    //flag our cached items so we lyra them to our peers
    budget.ResetSync();
    budget.ClearSeen();

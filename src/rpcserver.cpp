...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"rawtransactions", "lyrarawtransaction", &lyrarawtransaction, false, false, false},
        ...
        {"lyra", "initmasternode", &initmasternode, true, true, false},
        {"lyra", "masternodeisinit", &masternodeisinit, true, true, false},
        {"lyra", "killmasternode", &killmasternode, true, true, false},
...
#ifdef ENABLE_WALLET
        {"lyra", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of LyraMoney */
        ...
        {"wallet", "multilyra", &multilyra, false, false, true},
        {"wallet", "lyrafrom", &lyrafrom, false, false, true},
        {"wallet", "lyramany", &lyramany, false, false, true},
        {"wallet", "lyratoaddress", &lyratoaddress, false, false, true},
        {"wallet", "lyratoaddressix", &lyratoaddressix, false, false, true},
...
{
    // Lyra error reply from json-rpc error object
    ...
    const boost::system::error_code& error)
{
    ...
    // certain DoS and misbehaving clients.
        ...
        // Only lyra a 403 if we're not using SSL to prevent a DoS during the SSL handshake.
        if (!fUseSSL)

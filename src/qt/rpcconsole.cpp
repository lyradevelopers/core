...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    // Lyra command-line arguments to BitcoinGUI::handleRestart()
...
void RPCConsole::updateNodeDetail(const CNodeCombinedStats* stats)
{
    ...
    ui->peerLastLyra->setText(stats->nodeStats.nLastLyra ? GUIUtil::formatDurationStr(GetTime() - stats->nodeStats.nLastLyra) : tr("never"));
    ui->peerLastRecv->setText(stats->nodeStats.nLastRecv ? GUIUtil::formatDurationStr(GetTime() - stats->nodeStats.nLastRecv) : tr("never"));
    ui->peerBytesSent->setText(FormatBytes(stats->nodeStats.nLyraBytes));
...
void RPCConsole::showLyraFolder()
{
    GUIUtil::showLyraFolder();
}

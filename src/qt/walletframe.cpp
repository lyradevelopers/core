...
bool WalletFrame::handlePaymentRequest(const LyraCoinsRecipient& recipient)
{
...
void WalletFrame::gotoLyraCoinsPage(QString addr)
{
    QMap<QString, WalletView*>::const_iterator i;
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
        i.value()->gotoLyraCoinsPage(addr);
}
...
void WalletFrame::gotoMultiLyraDialog()
{
    WalletView* walletView = currentWalletView();

    if (walletView)
        walletView->gotoMultiLyraDialog();
}
...
void WalletFrame::usedLyraingAddresses()
{
    WalletView* walletView = currentWalletView();
    if (walletView)
        walletView->usedLyraingAddresses();
}

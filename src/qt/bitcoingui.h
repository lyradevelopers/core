...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitcoin wallet, and offers access to the list of transactions, address book and lyraing
        functionality.
    */
...
private:
    ...
    QAction* quitAction;
    QAction* lyraCoinsAction;
    QAction* usedLyraingAddressesAction;
    ...
    QAction* showLyraAction;
    QAction* openAction;
    QAction* openBlockExplorerAction;
    QAction* showHelpMessageAction;
    QAction* multiLyraAction;

...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::LyraToAddress:
    case TransactionRecord::LyraToOther:
        return tr("Sent to");
    case TransactionRecord::LyraToSelf:
...
QString TransactionTableModel::formatTooltip(const TransactionRecord* rec) const
{
    ...
    if (rec->type == TransactionRecord::RecvFromOther || rec->type == TransactionRecord::LyraToOther ||
        rec->type == TransactionRecord::LyraToAddress || rec->type == TransactionRecord::RecvWithAddress || rec->type == TransactionRecord::MNReward) {

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    connect(showLyraAction, SIGNAL(triggered()), rpcConsole, SLOT(showLyraFolder()));
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    lyraCoinsAction = new QAction(QIcon(":/icons/lyra"), tr("&Lyra"), this);
    lyraCoinsAction->setStatusTip(tr("Lyra coins to a LYRA address"));
    lyraCoinsAction->setToolTip(lyraCoinsAction->statusTip());
    lyraCoinsAction->setCheckable(true);
#ifdef Q_OS_MAC
    lyraCoinsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_2));
#else
    lyraCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
#endif
    tabGroup->addAction(lyraCoinsAction);
    ...
    // These showNormalIfMinimized are needed because Lyra Coins and Receive Coins
    // can be triggered from the tray menu, and need to show the GUI to be useful.
    connect(overviewAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(overviewAction, SIGNAL(triggered()), this, SLOT(gotoOverviewPage()));
    connect(lyraCoinsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(lyraCoinsAction, SIGNAL(triggered()), this, SLOT(gotoLyraCoinsPage()));
    ...
    multiLyraAction = new QAction(QIcon(":/icons/edit"), tr("&MultiLyra"), this);
    multiLyraAction->setToolTip(tr("MultiLyra Settings"));
    multiLyraAction->setCheckable(true);
    ...
    showLyraAction = new QAction(QIcon(":/icons/browse"), tr("Show configuration folder"), this);
    showLyraAction->setStatusTip(tr("Show LYRA configuration folder."));


    usedLyraingAddressesAction = new QAction(QIcon(":/icons/address-book"), tr("&Lyraing addresses..."), this);
    usedLyraingAddressesAction->setStatusTip(tr("Show the list of used lyraing addresses and labels"));
    ...
    if (walletFrame) {
        ...
        connect(usedLyraingAddressesAction, SIGNAL(triggered()), walletFrame, SLOT(usedLyraingAddresses()));
        connect(usedReceivingAddressesAction, SIGNAL(triggered()), walletFrame, SLOT(usedReceivingAddresses()));
        connect(openAction, SIGNAL(triggered()), this, SLOT(openClicked()));
        connect(multiLyraAction, SIGNAL(triggered()), this, SLOT(gotoMultiLyraDialog()));
    }
#endif // ENABLE_WALLET
}
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        file->addSeparator();
        file->addAction(usedLyraingAddressesAction);
    ...
    if (walletFrame) {
        ...
        settings->addAction(multiLyraAction);
    ...
    if (walletFrame) {
        ...
        tools->addAction(showLyraAction);
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        toolbar->addAction(lyraCoinsAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    lyraCoinsAction->setEnabled(enabled);
    ...
    usedLyraingAddressesAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIconMenu()
{
    ...
    trayIconMenu->addAction(lyraCoinsAction);
...
void BitcoinGUI::gotoLyraCoinsPage(QString addr)
{
    lyraCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoLyraCoinsPage(addr);
}
...
void BitcoinGUI::gotoMultiLyraDialog()
{
    multiLyraAction->setChecked(true);
    if (walletFrame)
        walletFrame->gotoMultiLyraDialog();
}
...
void BitcoinGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
    ...
    message((amount) < 0 ? (pwalletMain->fMultiLyraNotify == true ? tr("Sent MultiLyra transaction") : tr("Sent transaction")) : tr("Incoming transaction"),
        tr("Date: %1\n"
           "Amount: %2\n"
           "Type: %3\n"
           "Address: %4\n")
    ...
    pwalletMain->fMultiLyraNotify = false;
}
#endif // ENABLE_WALLET
...
#ifdef ENABLE_WALLET
bool BitcoinGUI::handlePaymentRequest(const LyraCoinsRecipient& recipient)
{
    // URI has to be valid

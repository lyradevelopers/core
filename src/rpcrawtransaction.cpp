...
Value createrawtransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "\nCreate a transaction spending the given inputs and lyraing to the given addresses.\n"
...
Value lyrarawtransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "lyrarawtransaction \"hexstring\" ( allowhighfees )\n"
            ...
            "\nLyra the transaction (signed hex)\n" + HelpExampleCli("lyrarawtransaction", "\"signedhex\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("lyrarawtransaction", "\"signedhex\""));

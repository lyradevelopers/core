...
static const unsigned int MAX_ADDR_TO_LYRA = 1000;
...
struct CNodeSignals {
    ...
    boost::signals2::signal<bool(CNode*, bool)> LyraMessages;
...
public:
    ...
    SOCKET hSocket;
    CDataStream ssLyra;
    size_t nLyraSize;   // total size of all vLyraMsg entries
    size_t nLyraOffset; // offset inside the first vLyraMsg already sent
    uint64_t nLyraBytes;
    std::deque<CSerializeData> vLyraMsg;
    CCriticalSection cs_vLyra;
    ...
    // Connecting to verify connectability/status or connecting for lyraing/relaying single message
...
protected:
    ...
    // Basic fuzz-testing
    void Fuzz(int nChance); // modifies ssLyra
...
public:
    ...
    // flood relay
    std::vector<CAddress> vAddrToLyra;
    ...
    std::vector<CInv> vInventoryToLyra;
...
public:
    ...
    void PushAddress(const CAddress& addr)
    {
        ...
        // LyraMessages will filter it again for knowns that were added
        // after addresses were pushed.
        if (addr.IsValid() && !setAddrKnown.count(addr)) {
            if (vAddrToLyra.size() >= MAX_ADDR_TO_LYRA) {
                vAddrToLyra[insecure_rand() % vAddrToLyra.size()] = addr;
            } else {
                vAddrToLyra.push_back(addr);
            }
        }
    }
    ...
    {
        {
            ...
            if (!setInventoryKnown.count(inv))
                vInventoryToLyra.push_back(inv);
        }
    }

    void AskFor(const CInv& inv);

    // TODO: Document the postcondition of this function.  Is cs_vLyra locked?
    void BeginMessage(const char* pszCommand) EXCLUSIVE_LOCK_FUNCTION(cs_vLyra);

    // TODO: Document the precondition of this function.  Is cs_vLyra locked?
    void AbortMessage() UNLOCK_FUNCTION(cs_vLyra);

    // TODO: Document the precondition of this function.  Is cs_vLyra locked?
    void EndMessage() UNLOCK_FUNCTION(cs_vLyra);
    ...
    void PushMessage(const char* pszCommand, const T1& a1, const T2& a2, const T3& a3, const T4& a4, const T5& a5, const T6& a6, const T7& a7, const T8& a8)
    {
        try {
            BeginMessage(pszCommand);
            ssLyra << a1 << a2 << a3 << a4 << a5 << a6 << a7 << a8;
            EndMessage();
        } catch (...) {
            AbortMessage();
            throw;
    ...
    void PushMessage(const char* pszCommand, const T1& a1, const T2& a2, const T3& a3, const T4& a4, const T5& a5, const T6& a6, const T7& a7, const T8& a8, const T9& a9)
    {
        try {
            BeginMessage(pszCommand);
            ssLyra << a1 << a2 << a3 << a4 << a5 << a6 << a7 << a8 << a9;
            EndMessage();
        } catch (...) {
            AbortMessage();
            throw;
    ...
    void PushMessage(const char* pszCommand, const T1& a1, const T2& a2, const T3& a3, const T4& a4, const T5& a5, const T6& a6, const T7& a7, const T8& a8, const T9& a9, const T10& a10)
    {
        try {
            BeginMessage(pszCommand);
            ssLyra << a1 << a2 << a3 << a4 << a5 << a6 << a7 << a8 << a9 << a10;
            EndMessage();
        } catch (...) {
            AbortMessage();
            throw;
    ...
    void PushMessage(const char* pszCommand, const T1& a1, const T2& a2, const T3& a3, const T4& a4, const T5& a5, const T6& a6, const T7& a7, const T8& a8, const T9& a9, const T10& a10, const T11& a11)
    {
        try {
            BeginMessage(pszCommand);
            ssLyra << a1 << a2 << a3 << a4 << a5 << a6 << a7 << a8 << a9 << a10 << a11;
            EndMessage();
        } catch (...) {
            AbortMessage();
            throw;
    ...
    void PushMessage(const char* pszCommand, const T1& a1, const T2& a2, const T3& a3, const T4& a4, const T5& a5, const T6& a6, const T7& a7, const T8& a8, const T9& a9, const T10& a10, const T11& a11, const T12& a12)
    {
        try {
            BeginMessage(pszCommand);
            ssLyra << a1 << a2 << a3 << a4 << a5 << a6 << a7 << a8 << a9 << a10 << a11 << a12;
            EndMessage();
        } catch (...) {
            AbortMessage();
            throw;
    ...
    // Dropping a node for lyraing stuff that is invalid

...
public:
    ...
    bool WriteMultiLyra(std::vector<std::pair<std::string, int> > vMultiLyra);
    bool EraseMultiLyra(std::vector<std::pair<std::string, int> > vMultiLyra);
    bool WriteMSettings(bool fMultiLyraStake, bool fMultiLyraMasternode, int nLastMultiLyraHeight);

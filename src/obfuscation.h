...
public:
    ...
    /// As a client, lyra a transaction to a Masternode to start the denomination process
    void LyraObfuscationDenominate(std::vector<CTxIn>& vin, std::vector<CTxOut>& vout, int64_t amount);

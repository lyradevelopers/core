...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    // Only check failure cases for lyrarawtransaction, there's no network to lyra to...
    BOOST_CHECK_THROW(CallRPC("lyrarawtransaction"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("lyrarawtransaction null"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("lyrarawtransaction DEADBEEF"), runtime_error);
    BOOST_CHECK_THROW(CallRPC(string("lyrarawtransaction ")+rawtx+" extra"), runtime_error);
}

...
extern bool fLyraFreeTransactions;
...
public:
    ...
    //MultiLyra
    std::vector<std::pair<std::string, int> > vMultiLyra;
    bool fMultiLyraStake;
    bool fMultiLyraMasternodeReward;
    bool fMultiLyraNotify;
    std::string strMultiLyraChangeAddress;
    int nLastMultiLyraHeight;
    ...
    void SetNull()
    {
        ...
        //MultiLyra
        vMultiLyra.clear();
        fMultiLyraStake = false;
        fMultiLyraMasternodeReward = false;
        fMultiLyraNotify = false;
        strMultiLyraChangeAddress = "";
        nLastMultiLyraHeight = 0;
    ...
    bool isMultiLyraEnabled()
    {
        return fMultiLyraMasternodeReward || fMultiLyraStake;
    }

    void setMultiLyraDisabled()
    {
        fMultiLyraMasternodeReward = false;
        fMultiLyraStake = false;
    }
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, CAmount> >& vecLyra,
        CWalletTx& wtxNew,

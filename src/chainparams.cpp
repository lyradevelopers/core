...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x68062914c0d75ac679c5729ac4af14ed5100b6ac1acad6daddfd3ccf16d67499") );
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1580406108, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 50050;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // LYRA starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // LYRA: 1 day
        nTargetSpacing = 1 * 30;  // LYRA: 30 seconds
        nLastPOWBlock = 101;
        nMaturity = 10;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1580406108;  
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2272739;
...
const int SCRYPT_SCRATCHPAD_SIZE = 131072 + 63;
        ...
        assert(hashGenesisBlock == uint256("0x68062914c0d75ac679c5729ac4af14ed5100b6ac1acad6daddfd3ccf16d67499"));
        //assert(genesis.hashMerkleRoot == uint256("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));

        //vSeeds.push_back(CDNSSeedData("dns.sociallyra.io", "seed.dns.sociallyra.io"));     // Primary DNS Seeder
        //vSeeds.push_back(CDNSSeedData("dns.sociallyra.info", "seed.dns.sociallyra.info"));
        //vSeeds.push_back(CDNSSeedData("lyra.goldlineit.org", "seed.lyra.goldlineit.org"));    // Secondary DNS Seeder from Remapper
        vSeeds.push_back(CDNSSeedData("173.230.139.237", "173.230.139.237"));         // Single node address
        vSeeds.push_back(CDNSSeedData("172.105.13.45", "172.105.13.45")); // Single node address
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // LYRA: 1 day
        nTargetSpacing = 1 * 60;  // LYRA: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet lyra addresses start with 'x' or 'y'
        ...
        // Testnet lyra BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet lyra BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet lyra BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Lyra: 1 day
        nTargetSpacing = 1 * 60;        // Lyra: 1 minutes
